...
public class DynamicDataSource implements DataSource {
	...
	private DataSource getDataSource() {
		 ...
		 */
		String entityId = LocalCompContext.getUserCompany();
		if (StringUtil.isNotEmpty(entityId)) {
			return this.getDataSource(DataSourceManager.BEAN_PREFIX + entityId);
		} else {
			return this.getDataSource(DataSourceManager.BEAN_PREFIX);
		}
	}
