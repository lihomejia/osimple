 ...
 * </ul>
 */
public final class Netty4SecureContextFactory {
    ...
    static {
        ...
        try {
            ...
            ks.load(Netty4SecureStore.asInputStream(),
            		Netty4SecureStore.getKeyStorePassword());

            // Set up key manager factory to use our key store
            KeyManagerFactory kmf = KeyManagerFactory.getInstance(algorithm);
            kmf.init(ks, Netty4SecureStore.getCertificatePassword());
        ...
        try {
            ...
            clientContext.init(null, Netty4SecureManagerFactory.getTrustManagers(), null);
        } catch (Exception e) {
            throw new Error(
    ...
    private Netty4SecureContextFactory() {
    }
}
